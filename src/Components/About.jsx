        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          <div className="grid sm:grid-cols-2 gap-6">
            <div className="bg-white p-8 rounded-xl shadow-sm border border-slate-100">
              ...
              <p className="text-slate-500 text-sm leading-relaxed">Đánh giá nhu cầu và xây dựng chiến lược phù hợp nhằm nâng cao hiệu quả vận hành và tối ưu ROI.</p>
            </div>

            <div className="bg-white p-8 rounded-xl shadow-sm border border-slate-100">
              <Search className="text-blue-600 mb-4" size={32} />
              <h4 className="font-bold text-slate-900 mb-2 italic">Low Code / No Code</h4>
              <p className="text-slate-500 text-sm leading-relaxed">Sử dụng Mendix và các công cụ khác để nhanh chóng tạo ra các ứng dụng tùy chỉnh phù hợp.</p>
            </div>
            ...
            <div className="bg-white p-8 rounded-xl shadow-sm border border-slate-100">
              ...
              <p className="text-slate-500 text-sm leading-relaxed">Đặt trải nghiệm khách hàng lên hàng đầu, triển khai quy trình hỗ trợ phản hồi nhanh chóng.</p>
            </div>
            ...
            <div className="bg-white p-8 rounded-xl shadow-sm border border-slate-100">
              ...
              <p className="text-slate-500 text-sm leading-relaxed">Cung cấp dịch vụ chuyên sâu về tích hợp hệ thống, đảm bảo độ chính xác và tuân thủ quy định.</p>
            </div>
          </div>
        </div>
      </div>
